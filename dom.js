...
const fatefulNumberDescs = {
  ...
  4: "Характер: Надеждни, трудолюбиви и практични, тези хора са силно организирани и ценят стабилността. Често се стремят към сигурност и предпочитат стабилни ос��ови във всичко, което правят.",
  ...
  8: "Характер: Амбициозни и фокусирани върху успеха, хората с число 8 често се стремят към финансово благополучие и власт. Те са практични, стабилни и добри лидери с усет за б��знес.",
...
function calculatePersonSoulNumber(personNum) {
  ...
  if (emailCheckbox.checked) {
    ...
    emailjs
      .send(
        "service_2ka3lwp", // Replace with your EmailJS service ID
        "template_yfvbfxa", // Replace with your EmailJS template ID
        {
          to_name: name,
